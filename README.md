...
Development: https://git.ligo.org/virgo/virgoapp/PyCm
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pycm-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pycm-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `pycm` available on your platform:
...
```
pixi search pycm --channel conda-forge
```
